                ...
                {!modelImageUrl ? (
                    ...
                    >
                        <main className="flex-grow relative flex flex-col md:flex-row overflow-hidden">
                            <div
                                className="w-full h-full flex-grow flex items-center justify-center bg-white pb-16 relative">
                                <Canvas
                            ...
                            {/*    >*/}
                            {/*        {isSheetCollapsed ? <ChevronUpIcon className="w-6 h-6 text-gray-500"/> :*/}
