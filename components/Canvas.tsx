...
import {Download, Share, UploadCloudIcon} from "lucide-react";
...
const Canvas: React.FC<CanvasProps> = ({
    ...
    return (
        <div className="w-full h-full items-center justify-center p-4 relative animate-zoom-in group">
            {/* Start Over Button */}
            {/*<button */}
            {/*    onClick={onStartOver}*/}
            ...
            <div className="grid relative w-full h-full items-center justify-center">
                <div >
                    {displayImageUrl ? (
                        <img
            ...
            {displayImageUrl && !isLoading && (
                ...
                >
                    ...
                    <div
                        className="flex items-center justify-center gap-2 bg-white/60 backdrop-blur-md rounded-full p-2 border border-gray-300/50">
                        <button
