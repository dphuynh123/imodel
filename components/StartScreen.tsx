...
const StartScreen: React.FC<StartScreenProps> = ({onModelFinalized}) => {
    ...
    const handleDownload = async () => {
        ...
        try {
            const base64Data = generatedModelUrl;
            // Create temporary link element
            const link = document.createElement("a");
            link.href = base64Data;
            link.download = "downloaded-image.png"; // set desired file name
                    ...
                    <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
                        <div className="max-w-lg">
                            ...
                            <p className="mt-4 text-lg text-gray-600">
                                Bạn đã bao giờ tự hỏi một bộ trang phục sẽ trông như thế nào trên người mình chưa? Đừng
                                đoán nữa. Hãy tải ảnh lên và tự mình trải nghiệm. AI của chúng tôi sẽ tạo ra người mẫu
                                cá nhân cho bạn, sẵn sàng để bạn thử nghiệm mọi thứ.
                            </p>
                        ...
                        {error &&
                            <div className="text-center md:text-left text-red-600 max-w-md mt-6">
                                ...
                                <button onClick={reset}
                                        className="text-sm font-semibold text-gray-700 hover:underline">Try Again
                                </button>
                            </div>
                        }
                        ...
                        <AnimatePresence>
                            {generatedModelUrl && !isGenerating && !error && (
                                ...
                                >
                                    <button
                                        onClick={reset}
                                        className="mt-2 z-30 flex items-center justify-center text-center bg-white/60 border border-gray-300/80 text-gray-700 font-semibold py-2 px-4 rounded-full transition-all duration-200 ease-in-out hover:bg-white hover:border-gray-400 active:scale-95 text-sm backdrop-blur-sm"
                                    >
                                        Thêm ảnh khác
                                    </button>
                                    <button
