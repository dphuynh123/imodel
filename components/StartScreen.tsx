          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Chọn ảnh rõ nét, toàn thân. Ảnh chỉ chụp khuôn mặt cũng được, nhưng ảnh toàn thân sẽ cho kết quả tốt nhất.</p>
                <p className="text-gray-500 text-xs mt-1">Bằng cách tải lên, bạn đồng ý không tạo ra nội dung độc hại, khiêu dâm hoặc bất hợp pháp. Dịch vụ này chỉ dành cho mục đích sử dụng sáng tạo và có trách nhiệm.</p>
